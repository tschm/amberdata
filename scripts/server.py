...
if __name__ == '__main__':
    ...
    with app.app_context():
        ...
        print(amberdata.request.prices.history(pair="eth_usd", time_interval=TimeInterval.DAYS,
        ...
        for exchange, data in amberdata.request.ohlcv.history("eth_usd", exchange="bitfinex,bitstamp", start_date=pd.Timestamp("2020-01-01"),end_date=pd.Timestamp("2020-02-13"), time_interval=TimeInterval.DAYS):
           print(exchange)
           print(data)
        ...
        for exchange, data in amberdata.request.bid_ask.history("eth_usd", exchange="bitfinex,bitstamp", start_date=pd.Timestamp("2020-01-01"),end_date=pd.Timestamp("2020-01-02")):
            print(exchange)
            print(data)
